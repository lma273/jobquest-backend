...
public class Job {
    ...
    public Job(String position, String company, String location, String experience, String description, List<String> skills) {
        ...
        public Job(String position, String company, String location, String experience, String description, List<String> skills, String recruiterEmail) {
        this.position = position;
        this.company = company;
        this.location = location;
        this.experience = experience;
    ...
    // Phương thức để trả về id dưới dạng chuỗi
